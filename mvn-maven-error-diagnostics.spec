...
Source4  : https://repo1.maven.org/maven2/org/apache/maven/maven-error-diagnostics/2.2.0/maven-error-diagnostics-2.2.0.jar
Source5  : https://repo1.maven.org/maven2/org/apache/maven/maven-error-diagnostics/2.2.0/maven-error-diagnostics-2.2.0.pom
Source6  : https://repo1.maven.org/maven2/org/apache/maven/maven-error-diagnostics/2.2.1/maven-error-diagnostics-2.2.1.jar
Source7  : https://repo1.maven.org/maven2/org/apache/maven/maven-error-diagnostics/2.2.1/maven-error-diagnostics-2.2.1.pom
...
cp %{SOURCE0} %{buildroot}/usr/share/java/.m2/repository/org/apache/maven/maven-error-diagnostics/2.0.6

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/maven/maven-error-diagnostics/2.0.6
cp %{SOURCE1} %{buildroot}/usr/share/java/.m2/repository/org/apache/maven/maven-error-diagnostics/2.0.6

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/maven/maven-error-diagnostics/2.0.7
cp %{SOURCE2} %{buildroot}/usr/share/java/.m2/repository/org/apache/maven/maven-error-diagnostics/2.0.7

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/maven/maven-error-diagnostics/2.0.7
cp %{SOURCE3} %{buildroot}/usr/share/java/.m2/repository/org/apache/maven/maven-error-diagnostics/2.0.7

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/maven/maven-error-diagnostics/2.2.0
cp %{SOURCE4} %{buildroot}/usr/share/java/.m2/repository/org/apache/maven/maven-error-diagnostics/2.2.0

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/maven/maven-error-diagnostics/2.2.0
cp %{SOURCE5} %{buildroot}/usr/share/java/.m2/repository/org/apache/maven/maven-error-diagnostics/2.2.0

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/maven/maven-error-diagnostics/2.2.1
cp %{SOURCE6} %{buildroot}/usr/share/java/.m2/repository/org/apache/maven/maven-error-diagnostics/2.2.1

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/maven/maven-error-diagnostics/2.2.1
cp %{SOURCE7} %{buildroot}/usr/share/java/.m2/repository/org/apache/maven/maven-error-diagnostics/2.2.1
